...
(/** @lends <global> */function (window, document, undefined) {
        ...
        */
        ...
        function _fnFeatureHtmlLength(settings) {
            ...
            var select = $('<select/>', {
                ...
                'class': classes.sLengthSelect + ' table_length_select'
            });
	 ...
	 */
        ...
        $.extend(DataTable.ext.classes, {
            ...
            "sLength": "dataTables_length marginbottom",
...
jQuery.extend(jQuery.fn.dataTableExt.oSort, {
    "date-euro-pre": function (a) {
        ...
        if ($.trim(a) !== '') {
            ...
            var timeString = frDatea[1].split(':');
            var dateString = frDatea[0].split('-');

            x = (dateString[2] + (dateString[1].length == 1 ? ("0" + dateString[1]) : dateString[1]) +
                (dateString[0].length == 1 ? ("0" + dateString[0]) : dateString[0]) +
                 (timeString[0].length == 1 ? ("0" + timeString[0]) : timeString[0]) +
               (timeString[1].length == 1 ? ("0" + timeString[1]) : timeString[1]) +
                (timeString[2].length == 1 ? ("0" + timeString[2]) : timeString[2])) * 1;
        }
        else {
            x = Infinity;
        }
