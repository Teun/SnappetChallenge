...
First, be sure, that `npm` installed on your PC

Second, run `npm install` to install project dependencies

Third, run `ng serve` for a dev server. Navigate to `http://localhost:4200/`. The app will automatically reload if you change any of the source files.
