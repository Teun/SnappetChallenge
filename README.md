...
### My contribution to the Snappet Challenge

This project will show a bar chart on the homepage showing the average progress per subject for today.
The second bar chart is interactive and will show the averages for the selected user for today.

The project is made in Visual Studio 2013.
