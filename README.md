...
Het project is vanuit Visual Studio op te starten, het is gemaakt met ASP.NET MVC 4.5.2. De JSON file wordt gebruikt om de data uit te lezen, hiervoor is geen database nodig.

Let op: Wel voor het starten de locatie van de JSON file wijzigen in Snappet.Data\SubmittedAnswerRepository.cs.
