...
WORKDIR /src
COPY ["Snappet.Challenge.DataFileToDynamoDB.csproj", "Snappet.Challenge.DataFileToDynamoDB/"]
RUN dotnet restore "Snappet.Challenge.DataFileToDynamoDB/Snappet.Challenge.DataFileToDynamoDB.csproj"

WORKDIR "/src/Snappet.Challenge.DataFileToDynamoDB"
COPY . .
RUN dotnet build "Snappet.Challenge.DataFileToDynamoDB.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "Snappet.Challenge.DataFileToDynamoDB.csproj" \
...
Execute unit tests
```
cd "Snappet.Challenge.DataFileToDynamoDB/test/Snappet.Challenge.DataFileToDynamoDB.Tests"
dotnet test
```

Deploy function to AWS Lambda
```
cd "Snappet.Challenge.DataFileToDynamoDB/src/Snappet.Challenge.DataFileToDynamoDB"
